...
import Category from '../src/models/cars';
import { model } from '../src/middleware/models';

const apiUrl = `http://localhost:${process.env.PORT}/api/v1/cars`;
